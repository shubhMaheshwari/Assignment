...
def instructions():
	...
	cprint("Goal is to kill all the enemies")
	cprint("You can use bombs to kill enemies but make sure they dont touch you or you get killed by your own bomb\n")
	cprint("Keys")
	cprint("q: exit the program\np:pause\n")
	cprint("	  w : Up")
	cprint("a : Left  s:Down  d:Right\n")
	cprint("b: set BOMB\nr:restart\n")
