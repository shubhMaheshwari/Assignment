		...
		try :
			...
			if game.bomb.time > 0:
				if self.orignal[game.bomb.y][game.bomb.x] != 'b' :
					self.orignal[game.bomb.y][game.bomb.x] = str(game.bomb.time)
				game.bomb.update()
				...
				for i in range(len(dirx)):
					if self.orignal[game.bomb.y + diry[i]][game.bomb.x + dirx[i]] == 'b':
						...
						self.orignal[game.bomb.y + diry[i]][game.bomb.x + dirx[i]] = 'x'
						...
						if self.orignal[game.bomb.y + 2*diry[i]][game.bomb.x + 2*dirx[i]] == 'b':							
							...
							self.orignal[game.bomb.y + 2*diry[i]][game.bomb.x + 2*dirx[i]] = 'x'		 
				return points		
				...
				for i in range(len(dirx)):												
					if self.orignal[game.bomb.y + diry[i]][game.bomb.x + dirx[i]] != '#':							
						...
						self.orignal[game.bomb.y + diry[i]][game.bomb.x + dirx[i]] = ' '
						
						if self.orignal[game.bomb.y + 2*diry[i]][game.bomb.x + 2*dirx[i]] != '#':								
							self.orignal[game.bomb.y + 2*diry[i]][game.bomb.x + 2*dirx[i]] = ' '	
