...
main(void)
{
  ...
  19:	e8 33 03 00 00       	call   351 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 56 03 00 00       	call   389 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 4a 03 00 00       	call   389 <dup>
  ...
  4b:	68 70 07 00 00       	push   $0x770
  50:	6a 01                	push   $0x1
  52:	e8 f9 03 00 00       	call   450 <printf>
    pid = fork();
  57:	e8 ad 02 00 00       	call   309 <fork>
    if(pid < 0){
  ...
  70:	e8 a4 02 00 00       	call   319 <wait>
  ...
  91:	53                   	push   %ebx
  92:	53                   	push   %ebx
  93:	68 83 07 00 00       	push   $0x783
  98:	6a 01                	push   $0x1
  9a:	e8 b1 03 00 00       	call   450 <printf>
      exit();
  9f:	e8 6d 02 00 00       	call   311 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 04 0b 00 00       	push   $0xb04
  ab:	68 96 07 00 00       	push   $0x796
  b0:	e8 94 02 00 00       	call   349 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 99 07 00 00       	push   $0x799
  bc:	6a 01                	push   $0x1
  be:	e8 8d 03 00 00       	call   450 <printf>
      exit();
  c3:	e8 49 02 00 00       	call   311 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 68 07 00 00       	push   $0x768
  d2:	e8 82 02 00 00       	call   359 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 68 07 00 00       	push   $0x768
  e0:	e8 6c 02 00 00       	call   351 <open>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e7:	f7 f1                	div    %ecx
 3e9:	0f b6 92 c0 07 00 00 	movzbl 0x7c0(%edx),%edx
  }while((x /= base) != 0);
 ...
 45b:	8d 44 24 48          	lea    0x48(%esp),%eax
{
 ...
 5fe:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 603:	bd b8 07 00 00       	mov    $0x7b8,%ebp
...
free(void *ap)
{
 ...
 617:	a1 0c 0b 00 00       	mov    0xb0c,%eax
  bp = (Header*) ap - 1;
 ...
 62e:	73 10                	jae    640 <free+0x30>
{
 ...
 679:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67c:	a3 0c 0b 00 00       	mov    %eax,0xb0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 693:	8b 44 24 10          	mov    0x10(%esp),%eax
  if((prevp = freep) == 0){
 697:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d7:	76 3f                	jbe    718 <malloc+0x88>
    ...
    if(p == freep)
 6d9:	39 05 0c 0b 00 00    	cmp    %eax,0xb0c
 ...
 6fe:	e8 0d ff ff ff       	call   610 <free>
  return freep;
 703:	8b 15 0c 0b 00 00    	mov    0xb0c,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 0c 0b 00 00    	mov    %edx,0xb0c
      return (void*) (p + 1);
 ...
 73c:	eb e9                	jmp    727 <malloc+0x97>
    base.s.ptr = freep = prevp = &base;
 73e:	c7 05 0c 0b 00 00 10 	movl   $0xb10,0xb0c
 745:	0b 00 00 
 748:	c7 05 10 0b 00 00 10 	movl   $0xb10,0xb10
 74f:	0b 00 00 
    base.s.size = 0;
 752:	b8 10 0b 00 00       	mov    $0xb10,%eax
 757:	c7 05 14 0b 00 00 00 	movl   $0x0,0xb14
 75e:	00 00 00 
