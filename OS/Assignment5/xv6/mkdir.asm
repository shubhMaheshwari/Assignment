...
printint(int fd, int xx, int base, int sgn)
{
 ...
 377:	f7 f1                	div    %ecx
 379:	0f b6 92 34 07 00 00 	movzbl 0x734(%edx),%edx
  }while((x /= base) != 0);
 ...
 3eb:	8d 44 24 48          	lea    0x48(%esp),%eax
{
 ...
 58e:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 593:	bd 2b 07 00 00       	mov    $0x72b,%ebp
...
free(void *ap)
{
 ...
 5a7:	a1 80 0a 00 00       	mov    0xa80,%eax
  bp = (Header*) ap - 1;
 ...
 5be:	73 10                	jae    5d0 <free+0x30>
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 609:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 60c:	a3 80 0a 00 00       	mov    %eax,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 623:	8b 44 24 10          	mov    0x10(%esp),%eax
  if((prevp = freep) == 0){
 627:	8b 15 80 0a 00 00    	mov    0xa80,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 667:	76 3f                	jbe    6a8 <malloc+0x88>
    ...
    if(p == freep)
 669:	39 05 80 0a 00 00    	cmp    %eax,0xa80
 ...
 68e:	e8 0d ff ff ff       	call   5a0 <free>
  return freep;
 693:	8b 15 80 0a 00 00    	mov    0xa80,%edx
 ...
 6b4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6b7:	89 15 80 0a 00 00    	mov    %edx,0xa80
      return (void*) (p + 1);
 ...
 6cc:	eb e9                	jmp    6b7 <malloc+0x97>
    base.s.ptr = freep = prevp = &base;
 6ce:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 6d5:	0a 00 00 
 6d8:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 6df:	0a 00 00 
    base.s.size = 0;
 6e2:	b8 84 0a 00 00       	mov    $0xa84,%eax
 6e7:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 6ee:	00 00 00 
