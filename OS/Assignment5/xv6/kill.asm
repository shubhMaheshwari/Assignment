...
printint(int fd, int xx, int base, int sgn)
{
 ...
 367:	f7 f1                	div    %ecx
 369:	0f b6 92 04 07 00 00 	movzbl 0x704(%edx),%edx
  }while((x /= base) != 0);
 ...
 3db:	8d 44 24 48          	lea    0x48(%esp),%eax
{
 ...
 57e:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 583:	bd fc 06 00 00       	mov    $0x6fc,%ebp
 ...
 5ae:	73 10                	jae    5c0 <free+0x30>
{
 ...
 5f9:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fc:	a3 50 0a 00 00       	mov    %eax,0xa50
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 657:	76 3f                	jbe    698 <malloc+0x88>
    ...
    if(p == freep)
 659:	39 05 50 0a 00 00    	cmp    %eax,0xa50
 ...
 67e:	e8 0d ff ff ff       	call   590 <free>
  return freep;
 683:	8b 15 50 0a 00 00    	mov    0xa50,%edx
 ...
 6a4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6a7:	89 15 50 0a 00 00    	mov    %edx,0xa50
      return (void*) (p + 1);
 ...
 6bc:	eb e9                	jmp    6a7 <malloc+0x97>
    base.s.ptr = freep = prevp = &base;
 6be:	c7 05 50 0a 00 00 54 	movl   $0xa54,0xa50
 6c5:	0a 00 00 
 6c8:	c7 05 54 0a 00 00 54 	movl   $0xa54,0xa54
 6cf:	0a 00 00 
    base.s.size = 0;
 6d2:	b8 54 0a 00 00       	mov    $0xa54,%eax
 6d7:	c7 05 58 0a 00 00 00 	movl   $0x0,0xa58
 6de:	00 00 00 
